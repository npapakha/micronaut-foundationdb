...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-foundationdb). This is required before any of your code or pull-requests are accepted.
...
Micronaut foundationdb currently requires JDK 21.

## IDE Setup

Micronaut foundationdb can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut foundationdb tests currently require Docker to be installed.
